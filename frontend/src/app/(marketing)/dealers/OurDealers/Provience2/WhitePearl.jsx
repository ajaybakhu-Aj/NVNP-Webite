...
const DEALER = {
    id: "white-pearl",
    name: "White Pearl",
    zone: "Zone 2 | Janakpur",
    badge: "VERIFIED DEALER",
    address: ["Janakpurdham, Dhanusha, Nepal",],
    city: "Janakpur 456001, Nepal",
    lat: "26.7286° N",
    lng: "85.9250° E",
    phone: ["+9779845990344"],
    ...
    about: [
        "White Pearl Pvt. Ltd. has been the cornerstone of security infrastructure in Morang for over a decade. As an authorized NV// NIGHTVISION™ partner, they specialize in the deployment of high-tier surveillance systems for both commercial and residential sectors.",
        "Their team of certified engineers provides end-to-end solutions, from site security assessment to precision hardware installation and 24/7 maintenance support. White Pearl is recognized for maintaining the highest technical standards in the region, ensuring that every deployment meets the rigorous NV// certification benchmarks.",
    ],
    stats: [
...
// ─── Main WhitePearl component ──────────────────────────────────────────────────
export default function WhitePearl() {
