...
const DEALER = {
    id: "sr-suppliers",
    name: "SR Suppliers",
    zone: "Zone 4 & 5 | Bardaghat",
    badge: "VERIFIED DEALER",
    address: ["Bardaghat, Nawalparasi, Nepal",],
    city: "Bardaghat 456001, Nepal",
    lat: "27.5500° N",
    lng: "83.8000° E",
    phone: ["+9779960457003"],
    whatsapp: ["+9779960457003"],
    hours: [
        { day: "Sun – Fri", time: "09:00 – 18:00", open: true },
        { day: "Saturday", time: "CLOSED", open: false },
    ],
    about: [
        "SR Suppliers Pvt. Ltd. has been the cornerstone of security infrastructure in Nawalparasi for over a decade. As an authorized NV// NIGHTVISION™ partner, they specialize in the deployment of high-tier surveillance systems for both commercial and residential sectors.",
        "Their team of certified engineers provides end-to-end solutions, from site security assessment to precision hardware installation and 24/7 maintenance support. SR Suppliers is recognized for maintaining the highest technical standards in the region, ensuring that every deployment meets the rigorous NV// certification benchmarks.",
    ],
    stats: [
...
// ─── Main SRSuppliers component ──────────────────────────────────────────────────
export default function SRSuppliers() {
