...
const DEALER = {
    id: "joshi-kyodai",
    name: "Joshi Kyodai",
    zone: "Zone 7 | Dhangadi",
    badge: "VERIFIED DEALER",
    address: ["Dhangadi, Kailali, Nepal",],
    city: "Dhangadi 456001, Nepal",
    lat: "28.7136° N",
    lng: "80.5692° E",
    phone: ["+9779869049449"],
    whatsapp: ["+9779869049449"],
    hours: [
        { day: "Sun – Fri", time: "09:00 – 18:00", open: true },
        { day: "Saturday", time: "CLOSED", open: false },
    ],
    about: [
        "Joshi Kyodai has been the cornerstone of security infrastructure in Dangadi for over a decade. As an authorized NV// NIGHTVISION™ partner, they specialize in the deployment of high-tier surveillance systems for both commercial and residential sectors.",
        "Their team of certified engineers provides end-to-end solutions, from site security assessment to precision hardware installation and 24/7 maintenance support. Joshi Kyodai is recognized for maintaining the highest technical standards in the region, ensuring that every deployment meets the rigorous NV// certification benchmarks.",
    ],
    stats: [
...
// ─── Main Joshi Kyodai component ──────────────────────────────────────────────────
export default function JoshiKyodai() {
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            if (b.label === "WhatsApp") {
                                                ...
                                                window.open(
                                                    "https://maps.app.goo.gl/HYBJZupqQaqkanKR7",
                                                    "_blank"
                                                );
                                            }
                                        }}
