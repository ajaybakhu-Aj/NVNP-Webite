      ...
      <div style={{ display: "flex", alignItems: "center", gap: 14, flex: 1, minWidth: 0 }}>
        <div
          style={{
            ...
            height: 38,
            borderRadius: 8,
            background: category.count > 0 ? "rgba(181, 231, 93,0.12)" : "rgba(255,255,255,0.04)",
    ...
    >
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .cat-add-input:focus, .cat-search-input:focus { border-color: #b5e75d !important; outline: none; }
      `}</style>
