...
backend_dir = os.path.join(cwd, 'backend') if os.path.exists(os.path.join(cwd, 'backend')) else cwd
...
for local_venv in [os.path.join(backend_dir, 'venv'), os.path.join(backend_dir, '.venv'), os.path.join(cwd, 'venv')]:
